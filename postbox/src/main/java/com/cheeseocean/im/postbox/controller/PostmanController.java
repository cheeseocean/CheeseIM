...
import com.cheeseocean.im.postbox.service.MessageStatisticsService;
...
public class PostmanController {
    ...
    public ResponseEntity<Map<String, Object>> setUserOnlineStatus(@PathVariable String userID,
        ...
        try {
            if (onlineUserService instanceof com.cheeseocean.im.postbox.service.impl.OnlineUserServiceImpl) {
                com.cheeseocean.im.postbox.service.impl.OnlineUserServiceImpl impl =
                    (com.cheeseocean.im.postbox.service.impl.OnlineUserServiceImpl) onlineUserService;
