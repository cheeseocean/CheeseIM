...
const (
	...
	TCPReadMsgReq                   = byte(33)
	TCPRevokeMsgReq                 = byte(34)
	TCPRevokeMsgNotify              = byte(35)
	TCPReadMsgNotify                = byte(36)
	TCPTypingReq                    = byte(37)
	TCPTypingNotify                 = byte(38)
	TCPDeliveryAckReq               = byte(39)
	TCPDeliveryNotify               = byte(40)
...
const (
	...
	CommandChatRevokeNotify   = byte(35)
	CommandChatReadNotify     = byte(36)
	CommandChatTyping         = byte(37)
	CommandChatTypingNotify   = byte(38)
	CommandChatDelivery       = byte(39)
	CommandChatDeliveryNotify = byte(40)
	CommandForceLogout        = byte(42)
