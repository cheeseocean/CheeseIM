...
@Configuration
@EnableDubbo(scanBasePackages = "com.cheeseocean.im.transfer.service")
...
public class TransferApplication {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(TransferApplication.class);
