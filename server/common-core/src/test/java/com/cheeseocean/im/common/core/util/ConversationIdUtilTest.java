...
class ConversationIdUtilTest {
    ...
    void singleConversationIdIsOrderIndependent() {
        assertEquals("s:u100:u200", ConversationIdUtil.single("u200", "u100"));
    }

    @Test
    void buildConversationIdSupportsGroupAndNotification() {
        assertEquals("g:g1", ConversationIdUtil.buildConversationId(ChatType.GROUP, null, null, "g1"));
        assertEquals("n:u9", ConversationIdUtil.buildConversationId(ChatType.NOTIFICATION, null, "u9", null));
    }
