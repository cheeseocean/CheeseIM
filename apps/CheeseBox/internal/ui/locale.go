...
var localeTable = map[LocaleName]map[localeKey]string{
	LocaleZhCN: {
		...
		keyHintInput:           "输入消息后回车发送  /chat <userId>  /revoke <serverMsgId|last> [reason]  /addfriend <userId> [message]  esc 标签",
		keyHelpTitle:           "帮助",
	...
	LocaleEnUS: {
		...
		keyHintInput:           "type message then enter  /chat <userId>  /revoke <serverMsgId|last> [reason]  /addfriend <userId> [message]  esc tabs",
		keyHelpTitle:           "Help",
