...
const (
	...
	keyLoginPassword      localeKey = "login.password"
...
var localeTable = map[LocaleName]map[localeKey]string{
	LocaleZhCN: {
		...
		keyHintInput:           "输入消息后回车发送  /addfriend <userId> [message]  esc 标签  tab 下一区域",
		keyHelpTitle:           "帮助",
	...
	LocaleEnUS: {
		...
		keyHintInput:           "type message then enter  /addfriend <userId> [message]  esc tabs  tab next area",
		keyHelpTitle:           "Help",
