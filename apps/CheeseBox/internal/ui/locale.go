...
var localeTable = map[LocaleName]map[localeKey]string{
	LocaleZhCN: {
		...
		keyHintInput:           "输入消息后回车发送  /requests  /accept|reject|cancel <userId>  /chat <userId>  /revoke <serverMsgId|last> [reason]  esc 标签",
		keyHelpTitle:           "帮助",
	...
	LocaleEnUS: {
		...
		keyHintInput:           "type message then enter  /requests  /accept|reject|cancel <userId>  /chat <userId>  /revoke <serverMsgId|last> [reason]  esc tabs",
		keyHelpTitle:           "Help",
